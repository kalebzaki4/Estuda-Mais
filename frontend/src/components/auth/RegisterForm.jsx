  ...
  return (
    <div>
      ...
      <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <div className="mt-5">
          <button type="submit" disabled={loading} className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-brand-500 to-brand-400 px-5 py-3 font-semibold text-white shadow-glow hover:shadow-soft transition-all disabled:opacity-70 disabled:cursor-not-allowed">
