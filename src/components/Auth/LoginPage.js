    ...
    <div className="min-h-screen bg-bg-dark-primary text-text-light p-4 flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 flex-col justify-center items-center p-8 bg-gradient-to-br from-bg-dark-secondary to-accent-purple-dark rounded-l-xl">
        <div className="max-w-lg">
          ...
          <h2 className="text-3xl font-bold text-text-light mb-4">Bem-vindo de volta!</h2>
          <p className="text-xl text-text-muted-dark mb-8">Continue sua jornada de aprendizado e alcance seus objetivos acadêmicos.</p>
          ...
          <div className="w-full max-w-md mx-auto my-8 animate-pulse-subtle">
            <svg className="w-full" viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M150 250c-8.284 0-15-6.716-15-15 0-8.284 6.716-15 15-15h200c8.284 0 15 6.716 15 15 0 8.284-6.716 15-15 15H150z" fill="#8a2be2" fillOpacity="0.3"/>
              <path d="M150 300c-8.284 0-15-6.716-15-15 0-8.284 6.716-15 15-15h150c8.284 0 15 6.716 15 15 0 8.284-6.716 15-15 15H150z" fill="#8a2be2" fillOpacity="0.3"/>
              <path d="M150 350c-8.284 0-15-6.716-15-15 0-8.284 6.716-15 15-15h100c8.284 0 15 6.716 15 15 0 8.284-6.716 15-15 15H150z" fill="#8a2be2" fillOpacity="0.3"/>
              <circle cx="250" cy="150" r="50" fill="#8a2be2" fillOpacity="0.4"/>
              <path d="M250 120v60M220 150h60" stroke="white" strokeWidth="4" strokeLinecap="round"/>
            </svg>
          </div>
          ...
          <div className="flex space-x-4 mt-8">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-text-muted-dark">Estudos personalizados</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-info-blue rounded-full"></div>
              <span className="text-text-muted-dark">Progresso em tempo real</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center">
        <div className="w-full max-w-md p-8 bg-bg-dark-secondary rounded-xl md:rounded-l-none md:rounded-r-xl shadow-custom-dark-lg animate-fade-in">
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-text-muted-dark">Faça login para continuar</p>
          </div>
          
          <h2 className="text-2xl font-bold mb-6 hidden md:block">Entrar na sua conta</h2>
